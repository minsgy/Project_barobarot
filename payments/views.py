...
class payment_do(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['engineers'] = engineer_model.Engineer
        return context
...
def PaymentproductCreate(request, product_pk, user_pk):
    ...
    # engineer_data = engineer_model.Engineer.objects.get(pk=engineer_pk)   #엔지니어 연결
    ...
    if request.method == 'POST':
        ...
        paymentproducts.visit_date = core_models.TimeStampedModel.created
